...
import { BlueprintFloorplan } from '../visuals/BlueprintFloorplan'
...
export function Problem() {
  ...
  return (
    <Section id="problem" bordered className="isolate">
      ...
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-12 lg:gap-x-12 items-start">
          ...
          {/* Blueprint floor-plan — drawn line-by-line on scroll */}
          <div className="hidden lg:flex lg:col-span-4 xl:col-span-3 lg:col-start-9 xl:col-start-10 justify-end pt-32">
