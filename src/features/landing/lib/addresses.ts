...
export const addresses: Address[] = [
  {
    ...
    details_de: {
      ...
      bauordnung: 'BayBO Art. 60 — reguläres Baugenehmigungsverfahren',
    ...
    details_en: {
      ...
      bauordnung: 'BayBO Art. 60 — full permit procedure',
  ...
  },
  {
    ...
    details_de: {
      ...
      bauordnung: 'BayBO Art. 59 — vereinfachtes Verfahren',
    ...
    details_en: {
      ...
      bauordnung: 'BayBO Art. 59 — simplified procedure',
  ...
  },
  {
    ...
    details_de: {
      ...
      bauordnung: 'BayBO Art. 58 — Genehmigungsfreistellung',
    ...
    details_en: {
      ...
      bauordnung: 'BayBO Art. 58 — exempt procedure',
