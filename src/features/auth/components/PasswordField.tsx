    ...
    <div className={cn('flex flex-col gap-2', className)}>
      ...
      <div className="relative">
        <input
          ...
          className={cn(
            'w-full bg-transparent border-0 border-b border-ink/25 py-2.5 pl-0 pr-9 text-base text-ink placeholder:text-ink/40 transition-colors duration-soft ease-soft',
