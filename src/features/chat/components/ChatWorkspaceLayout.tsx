 ...
 */
export function ChatWorkspaceLayout({ leftRail, rightRail, children }: Props) {
  return (
    <div className="min-h-dvh bg-paper relative isolate">
      ...
      <div className="mx-auto w-full max-w-[1440px] grid lg:grid-cols-[280px_minmax(0,1fr)_360px] grid-cols-1">
        {/* Left rail — desktop only in this commit; drawer affordance lands in #14. */}
        <aside className="hidden lg:flex border-r border-border-strong/30 min-h-dvh">
          {leftRail}
        </aside>

        {/* Center — thread + sticky input bar (input bar lands in batch 4). */}
        ...
        {/* Right rail — desktop only in this commit. */}
