...
export function SpineDebugPanel({ project, messages, stages, progress }: Props) {
  ...
  return (
    <aside
      ...
      className="fixed top-14 right-4 z-[var(--z-debug)] w-[340px] max-h-[80vh] overflow-y-auto bg-paper border border-clay/40 rounded-md p-3 font-mono text-[11px] leading-tight"
    >
