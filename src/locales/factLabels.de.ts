...
export const factLabelsDe: Record<string, FactLabel> = {
  ...
  // ── v1.0.29 Bug 71/81 — T-02 MFH fact keys (DE mirror of factLabels.en).
  //    Both dotted (persona namespace) and flat-snake forms registered.
  'bundesland': { label: 'Bundesland' },
  'vorhaben.typ': { label: 'Art des Vorhabens' },
  'vorhaben_typ': { label: 'Art des Vorhabens' },
  'vorhaben.nutzung': { label: 'Nutzungsart' },
  'vorhaben_nutzung': { label: 'Nutzungsart' },
  'gebaeudeklasse': { label: 'Gebäudeklasse' },
  'vollgeschosse': { label: 'Vollgeschosse' },
  'wohneinheiten.anzahl': { label: 'Anzahl Wohneinheiten' },
  'wohneinheiten_anzahl': { label: 'Anzahl Wohneinheiten' },
  'wohneinheit.flaeche_m2': { label: 'Fläche je Wohneinheit', unit: 'm²' },
  'wohneinheit_flaeche_m2': { label: 'Fläche je Wohneinheit', unit: 'm²' },
  'wohnflaeche_gesamt_m2': { label: 'Wohnfläche gesamt', unit: 'm²' },
  'wohnflaeche_gesamt': { label: 'Wohnfläche gesamt', unit: 'm²' },
  'okff_oberstes_geschoss_m': { label: 'OKFF oberstes Geschoss', unit: 'm' },
  'sonderbau_tatbestand': { label: 'Sonderbau-Tatbestand' },
  'planungsrecht.rechtsgrundlage': { label: 'Planungsrechtliche Grundlage' },
  'planungsrecht_rechtsgrundlage': { label: 'Planungsrechtliche Grundlage' },
  'planungsrecht.bebauungsplan_status': { label: 'Bebauungsplan-Status' },
  'planungsrecht.erhaltungssatzung_moeglich': { label: 'Erhaltungssatzung möglich' },
  'verfahren.typ': { label: 'Verfahrensart' },
  'verfahren_typ': { label: 'Verfahrensart' },
  'verfahren_indikation': { label: 'Verfahrens-Indikation' },
  'architekt.beauftragt': { label: 'Architekt:in beauftragt' },
  'architekt.kammer': { label: 'Architektenkammer' },
  'kernteam.architekt_register': { label: 'Architekten-Register' },
  'kernteam.bestaetigt': { label: 'Kernteam bestätigt' },
  'stellplatz.anzahl_geplant': { label: 'Geplante Stellplätze' },
  'stellplatz_anzahl_geplant': { label: 'Geplante Stellplätze' },
  'stellplatz.typ': { label: 'Stellplatz-Typ' },
  'stellplatz_typ': { label: 'Stellplatz-Typ' },
  'stellplatz.reduktion_moeglich': { label: 'Stellplatz-Reduktion möglich' },
