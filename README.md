...
Phase 3.8 makes mobile the primary surface. See [`docs/mobile-support.md`](docs/mobile-support.md) for supported devices, known limitations, and the testing protocol.
